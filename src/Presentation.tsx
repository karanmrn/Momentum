...
const slides = [
  {
    ...
    steps: [
      ...
      "Return for updates and corrections",
    ],
  },
  {
    ...
    steps: [
      "Check who published the information",
      "Check its date and coverage",
      "Check help availability before relying on it",
    ],
  },
  {
    ...
    steps: [
      "Share a fictional report privately",
      "Review before public publication",
      "Keep corrections visible in later updates",
    ],
  },
  {
    ...
    steps: [
      "Read local sources",
      "Switch between the list and map",
      "Find help and check its source",
    ],
  },
];
